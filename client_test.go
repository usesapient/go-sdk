...
func TestUserAgentHeader(t *testing.T) {
	...
	_, _ = client.Status.Get(context.Background())
	if userAgent != fmt.Sprintf("Sapient/Go %s", internal.PackageVersion) {
...
func TestRetryAfter(t *testing.T) {
	...
	_, err := client.Status.Get(context.Background())
	if err == nil {
...
func TestContextCancel(t *testing.T) {
	...
	cancel()
	_, err := client.Status.Get(cancelCtx)
	if err == nil {
		t.Error("Expected there to be a cancel error")
	}
}
...
func TestContextDeadline(t *testing.T) {
	...
	go func() {
		...
		_, err := client.Status.Get(deadlineCtx)
		if err == nil {
